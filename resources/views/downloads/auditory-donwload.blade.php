...
<body>
    ...
    <div class="mx-2 mt-4">
        ...
        <h2 class="text-center">https://api.mapbox.com/styles/v1/mapbox/streets-v12/static/pin-s+555555({{ $data['auditory']['lng'] }},{{ $data['auditory']['lat'] }})/{{ $data['auditory']['lng'] }},{{ $data['auditory']['lat'] }},16,0/300x200?access_token={{ env('MAPBOX_KEY') }}</h2>
